  ...
  return (
    <div className="container-page max-w-4xl py-12">
      ...
      <p className="mt-6 text-lg leading-8 text-muted-foreground">
        LedgerWise aims to provide readable finance education for people using keyboards, screen readers, mobile devices,
      ...
      <div className="mt-10 grid gap-5 md:grid-cols-2">
        {[
          ...
          ["Feedback", "Readers can contact editors@ledgerwise.com with accessibility barriers or readability problems."]
        ].map(([title, copy]) => (
